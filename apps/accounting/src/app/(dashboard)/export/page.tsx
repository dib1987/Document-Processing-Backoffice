    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-5">
        ...
        <p className="text-sm text-slate-400 mb-4">
          Narrow the export by status or date range. Leave blank to export everything.
        </p>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-slate-400 mt-0.5">
              Job metadata and extracted fields in a spreadsheet-friendly format. Opens directly in Excel or Google Sheets.
            </p>
            <ul className="mt-2 space-y-1 text-xs text-slate-500 list-disc list-inside">
              <li>Job ID, filename, document type, status</li>
              <li>Extracted fields (taxpayer name, tax year, balances, etc.)</li>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-5">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-slate-400 mt-0.5">
              Full structured export including confidence scores, validation flags, and optionally the complete audit trail per document.
            </p>
            <ul className="mt-2 space-y-1 text-xs text-slate-500 list-disc list-inside">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 disabled:opacity-50 shrink-0"
          >
            <Download className="w-4 h-4" />
      ...
      <div className="bg-slate-50 rounded-xl border border-slate-200 p-4">
        <p className="text-xs text-slate-500 leading-relaxed">
          ...
          SSNs and account numbers are already masked in the source data and will appear masked in the export.
