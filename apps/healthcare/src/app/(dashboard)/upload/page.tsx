...
const DOC_TYPES: DocType[] = ['patient_intake', 'insurance_authorization', 'clinical_support']

export default function UploadPage() {
  const [file, setFile] = useState<File | null>(null)
  const [docType, setDocType] = useState<DocType>('patient_intake')
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <button
        ...
        className="w-full py-3 bg-teal-600 text-white font-medium rounded-xl hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          ...
          {isTerminal && (
            <button
              ...
              className="mt-4 w-full py-2 text-sm font-medium text-teal-600 border border-teal-200 rounded-lg hover:bg-teal-50 transition-colors"
            >
