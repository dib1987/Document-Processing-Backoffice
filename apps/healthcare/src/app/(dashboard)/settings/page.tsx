...
const HEALTHCARE_DOC_TYPES: DocType[] = [
  'patient_intake',
...
export default function SettingsPage() {
  ...
  const [activeDocType, setActiveDocType] = useState<DocType>('patient_intake')
  ...
  useEffect(() => {
    ...
    for (const dt of HEALTHCARE_DOC_TYPES) {
